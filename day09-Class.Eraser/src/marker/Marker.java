...
public class Marker {
	...
	public void print() {
		if(isOpened) {
			if(isFulled) {
				System.out.printf("%s색 마커가 뚜껑은 열려있고 잉크는 가득 차 있는 상태입니다%n", color);
			} else {
				System.out.printf("%s색 마커가 뚜껑이 열려있고 잉크가 다 쓴 상태입니다%n", color);
			}
		}
		if (isOpened) {
			if(isFulled) {
				System.out.printf("%s색 마커가 뚜껑이 닫혀있고 잉크는 가득 차 있는 상태입니다%n", color);
			} else {
				System.out.printf("%s색 마커가 뚜껑이 닫혀있고 잉크도 다 쓴 상태입니다%n", color);
			}
		}
	}
	public void print2() {
