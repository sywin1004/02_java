...
/**
 * Book 여러개가 꼽혀있어 책 객체 여러개를 한번에 저장하고 관리할 수 있는 클래스
 * 
...
public class ArrayBookShelf implements BookShelf {
	 ...
	 * 
	 * 2. 매개변수로 입력된 book 객체가 이미 목록에 존재하는지 여부를
	 * 
	 * isExists(book) 메소드를 사용하여 판단하고 isExists(book) 의 결과가 false 일 때만 현재의 추가로직이 작동하도록
	 * 변경
	 * 
	 * @param book
	 * @return 0 : 이미 같인 seq 번호의 책이 있어서 추가 실패 1 : 새 책 정보 1건이 성공적으로 추가된 경우
	 ...
	 * 
	 * 결과가 true 일 때만 삭제로직 진행 1리턴 결과가 false 이면 삭제로직 진행 없이 0리턴
	 * 
	 * @param book
	 ...
	 * 
	 * true 이면 수정하고 1리턴 false 이면 수정진행하지 않고 0리턴
	 * 
	 * @param book
	 * @throws NotFoundException 
	 */
	 ...
	 * --------------------------------------- 같은 책을 찾는 로직을 sequence 값 직접 비교에서 book
	 * 객체 비교로 변경 ---------------------------------------
	 * 
	 * @param book
	 * @return
	 ...
	 * 
	 * @param book
	 * @return true : 찾는 책이 목록에 존재, false : 찾는 책이 목록에 없을 때
	 */
